<script>
  ...
  <div class="game-board before-game">
...
.daemon-card.showCard {
  animation: daemonShowCard .5s ease-out;
}
...
.daemon-card.better-card {
  transform: scale(1.03);
}

.daemon-card.worse-card {
